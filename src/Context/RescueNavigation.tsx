...
export type RescueTaskStackParamList = {
  ...
  RescueTaskDetail: {
    taskId: string; // - Thống nhất dùng taskId
  };
  ChatScreen: { requestId: string; receiverName: string };
};
...
function RescueTaskStack() {
  return (
    <TaskStack.Navigator screenOptions={{ headerShown: false }}>
      ...
      <TaskStack.Screen name="ChatScreen" component={ChatScreen} />
    </TaskStack.Navigator>
  );
}
  ...
  return (
    <Tab.Navigator
      screenOptions={{
        ...
        tabBarStyle: { height: 64, paddingBottom: 8, paddingTop: 8, borderTopWidth: 0, elevation: 8, backgroundColor: "#fff" },
      }}
    >
      <Tab.Screen
        name="RescueHome"
      ...
      <Tab.Screen
        ...
        options={{ title: "Tasks", tabBarIcon: ({ color, size }) => <Ionicons name="list-outline" size={size} color={color} /> }}
      />
      <Tab.Screen
        name="RescueHistory"
